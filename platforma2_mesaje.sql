...
CREATE TABLE `mesaje` (
  ...
  `mesaj` varchar(45) DEFAULT NULL,
  `data` datetime DEFAULT NULL,
  KEY `id_curs` (`id_curs`),
  KEY `fromId` (`fromId`),
  CONSTRAINT `mesaje_ibfk_1` FOREIGN KEY (`id_curs`) REFERENCES `prof_curs` (`id_curs`),
  CONSTRAINT `mesaje_ibfk_2` FOREIGN KEY (`fromId`) REFERENCES `studenti` (`id_student`)
