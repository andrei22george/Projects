...
CREATE TABLE `programari` (
  ...
  KEY `id_curs` (`id_curs`),
  CONSTRAINT `programari_ibfk_1` FOREIGN KEY (`id_curs`) REFERENCES `prof_curs` (`id_curs`)
...
INSERT INTO `programari` VALUES (1,3,'2023-01-18 00:00:00','lab',NULL),(2,3,'2023-01-19 00:00:00','Intalnire crepusculara','20:00'),(3,3,'2023-01-17 23:00:00','test','23:00');
